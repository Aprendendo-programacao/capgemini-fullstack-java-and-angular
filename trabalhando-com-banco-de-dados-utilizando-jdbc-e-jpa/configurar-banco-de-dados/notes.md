...
* Acesso e atualização dos dados mais rápido e performático
...
* **Referência**: [danielkv7](https://github.com/danielkv7/jdbc-basico/blob/master/src/main/java/part1/DatabaseInstructions)